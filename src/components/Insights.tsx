...
//     },
//     {
//       icon: monthlyComparison.increased ? TrendingUp : TrendingDown,
//       title: 'Monthly Expense Change',
//       value: `${monthlyComparison.change.toFixed(1)}%`,
//       description: monthlyComparison.increased
//         ? 'Increase from last month'
//         : 'Decrease from last month',
//       color: monthlyComparison.increased ? 'red' : 'green',
//     },
//     {
//       icon: DollarSign,
//       title: 'Savings Rate',
...
//       message: 'You\'re saving over 20% of your income. Keep up the excellent work!',
//     });
//   }

//   if (monthlyComparison.increased && monthlyComparison.change > 10) {
//     recommendations.push({
//       type: 'warning',
//       title: 'Spending Increase',
//       message: `Your expenses increased by ${monthlyComparison.change.toFixed(1)}% this month. Review your spending habits.`,
//     });
//   }
...
//         message: `${percentage.toFixed(1)}% of your expenses are in ${topCategory.name}. Consider diversifying your spending.`,
//       });
//     }
//   }
...
//       type: 'success',
//       title: 'Looking Good',
//       message: 'Your finances are well-balanced. Continue monitoring your spending patterns.',
//     });
//   }
...
//           Automated analysis of your financial activity
//         </p>
//       </div>
...
//           </h3>
//           <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
//             Add transactions to see financial insights and recommendations.
//           </p>
//         </div>
//       ) : (
//         <>
